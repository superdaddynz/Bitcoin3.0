 ...
 */
#ifndef BITCOIN3_UTIL_H
#define BITCOIN3_UTIL_H
...
extern const char * const BITCOIN3_CONF_FILENAME;
extern const char * const BITCOIN3_PID_FILENAME;
...
{
    std::string s = strprintf("bitcoin3-%s", name);
