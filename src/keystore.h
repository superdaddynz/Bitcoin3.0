...
#ifndef BITCOIN3_KEYSTORE_H
#define BITCOIN3_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/bitcoin3/bips/blob/master/bip-0013.mediawiki
