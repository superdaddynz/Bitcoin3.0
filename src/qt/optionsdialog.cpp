    ...
    mapper(0)
{
    ...
    ui->bitcoin3AtStartup->setToolTip(ui->bitcoin3AtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->bitcoin3AtStartup->setText(ui->bitcoin3AtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openBitcoin3ConfButton->setToolTip(ui->openBitcoin3ConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new Bitcoin3Units(this));
...
{
    /* Main */
    mapper->addMapping(ui->bitcoin3AtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openBitcoin3ConfButton_clicked()
{
