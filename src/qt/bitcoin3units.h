...
#ifndef BITCOIN3_QT_BITCOIN3UNITS_H
#define BITCOIN3_QT_BITCOIN3UNITS_H
...
/** Bitcoin3 unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class Bitcoin3Units: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit Bitcoin3Units(QObject *parent);

    /** Bitcoin3 units.
      @note Source: https://en.bitcoin3.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC3,
...
typedef Bitcoin3Units::Unit Bitcoin3Unit;

#endif // BITCOIN3_QT_BITCOIN3UNITS_H
