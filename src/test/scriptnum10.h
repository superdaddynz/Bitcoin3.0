...
#ifndef BITCOIN3_TEST_SCRIPTNUM10_H
#define BITCOIN3_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Bitcoin3 Core 0.10.0, for cross-comparison.
 */
public:
