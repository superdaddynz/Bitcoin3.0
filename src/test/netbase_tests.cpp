...
{
    BOOST_CHECK(TestSplitHost("www.bitcoin3core.org", "www.bitcoin3core.org", -1));
    BOOST_CHECK(TestSplitHost("[www.bitcoin3core.org]", "www.bitcoin3core.org", -1));
    BOOST_CHECK(TestSplitHost("www.bitcoin3core.org:80", "www.bitcoin3core.org", 80));
    BOOST_CHECK(TestSplitHost("[www.bitcoin3core.org]:80", "www.bitcoin3core.org", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:30268", "127.0.0.1", 30268));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:30268", "127.0.0.1", 30268));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:30268", "::ffff:127.0.0.1", 30268));
    BOOST_CHECK(TestSplitHost("[::]:30268", "::", 30268));
    BOOST_CHECK(TestSplitHost("::30268", "::30268", -1));
    BOOST_CHECK(TestSplitHost(":30268", "", 30268));
    BOOST_CHECK(TestSplitHost("[]:30268", "", 30268));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:30268", "127.0.0.1:30268"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:30268", "[::]:30268"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
