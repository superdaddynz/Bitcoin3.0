...
static void SetupBitcoin3TxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bitcoin3-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bitcoin3-tx [options] <hex-tx> [commands]  Update hex-encoded bitcoin3 transaction\n" +
            "or:     bitcoin3-tx [options] -create [commands]   Create hex-encoded bitcoin3 transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoin3 transaction
