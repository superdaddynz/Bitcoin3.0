...
#ifndef BITCOIN3_WALLET_WALLET_H
#define BITCOIN3_WALLET_WALLET_H
...
public:
     ...
     * on this bitcoin3 node, and set to 0 for transactions that were created
...
#endif // BITCOIN3_WALLET_WALLET_H
