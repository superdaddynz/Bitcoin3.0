...
#ifndef BITCOIN3_INTERFACES_NODE_H
#define BITCOIN3_INTERFACES_NODE_H
...
//! Top-level interface for a bitcoin3 node (bitcoin3d process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // BITCOIN3_INTERFACES_NODE_H
