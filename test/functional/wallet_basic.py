...
class WalletTest(Bitcoin3TestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 BTC3 from 0 to 2 using sendtoaddress call.
        ...
        # node0 should end up with 100 btc3 in block rewards plus fees, but
        ...
        # Send 10 BTC3 with subtract fee from amount
        ...
        # Sendmany 10 BTC3 with subtract fee from amount
        ...
        maintenance = [
            ...
            '-zapwallettxes=1',
            '-zapwallettxes=2',
            # disabled until issue is fixed: https://github.com/bitcoin3/bitcoin3/issues/7463
            # '-salvagewallet',
        ]
        chainlimit = 6
