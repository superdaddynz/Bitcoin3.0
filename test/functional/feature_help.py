...
"""Verify that starting bitcoin3 with -h works as expected."""

from test_framework.test_framework import Bitcoin3TestFramework
from test_framework.util import assert_equal

class HelpTest(Bitcoin3TestFramework):
    ...
    def run_test(self):
        self.log.info("Start bitcoin3 with -h for help text")
        ...
        self.log.info("Start bitcoin3 with -version for version information")
        ...
        self.log.info("Start bitcoin3d with -fakearg to make sure it does not start")
