...
class FullBlockTest(Bitcoin3TestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure bitcoin3d isn't accepting b26
        ...
        # Extend the b28 chain to make sure bitcoin3d isn't accepting b28
        ...
        # bitcoin3d doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the bitcoin3 code has custom code which does so);
