...
class BIP66Test(Bitcoin3TestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # bitcoin3d is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and bitcoin3d produces more specific reject
            # reasons.
