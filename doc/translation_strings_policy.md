...
This document provides guidelines for internationalization of the Bitcoin3 Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bitcoin3_en.ts` remains unchanged.
