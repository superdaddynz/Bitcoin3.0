...
* bitcoin3.conf: contains configuration settings for bitcoin3d or bitcoin3-qt
* bitcoin3d.pid: stores the process id of bitcoin3d while running
...
* debug.log: contains debug information and general logging generated by bitcoin3d or bitcoin3-qt
